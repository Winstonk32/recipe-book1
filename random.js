let savedRecipes = [
    { id: 1, title: 'Spaghetti Bolognese', image: 'food/sphag.jpg', ingredients: ['Pasta', 'Tomato Sauce', 'Ground Beef'], instructions: 'Cook pasta, brown ground beef, combine with sauce.' },
    { id: 2, title: 'Chicken Curry', image: 'food/curry.webp', ingredients: ['Chicken', 'Curry Powder', 'Coconut Milk'], instructions: 'Cook chicken with curry powder and coconut milk.' }
  ];
